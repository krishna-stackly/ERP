...
// // export default function CustomImport({ setShowCustomImport, setCustomers }) {
// //   const [files, setFiles] = useState([]);
// //   const [isDragging, setIsDragging] = useState(false);
...
// //   // ── STEP 1: VALIDATE ─────────────────────────────────────────
// //   // Delegates to customerApiProvider.importValidate(file)
...
// //     const data = await customerApiProvider.importValidate(files[0]);
...
// //   // Delegates to customerApiProvider.importConfirm(validRows)
...
// //     const data = await customerApiProvider.importConfirm(validationResult.valid_rows);
...
// //     if (data) setShowCustomImport(false); // only close on success
// //   };
...
// //           <p>Import customers from CSV/Excel</p>
// //           <nav onClick={() => setShowCustomImport(false)}>
// //             <svg className="circle-x-logo-customImport" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
// //               <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM175 175c9.4-9.4 24.6-9.4 33.9 0l47 47 47-47c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9l-47 47 47 47c9.4 9.4 9.4 24.6 0 33.9s-24.6 9.4-33.9 0l-47-47-47 47c-9.4 9.4-24.6 9.4-33.9 0s-9.4-24.6 0-33.9l47-47-47-47c-9.4-9.4-9.4-24.6 0-33.9z" />
// //             </svg>
// //             <p>Close</p>
// //           </nav>
...
// //         <div className="customImport-downloadTemplate-container">
// //           <nav className="customImport-downloadTemplate-title">1. Download Template :</nav>
// //           <a href="/sample_customers.csv" download className="customImport-download-btn-container">
// //             <svg className="customImport-download-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
// //               <path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32v242.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM64 352c-35.3 0-64 28.7-64 64v32c0 35.3 28.7 64 64 64h384c35.3 0 64-28.7 64-64v-32c0-35.3-28.7-64-64-64H346.5l-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352H64zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z" />
// //             </svg>
// //             <span>Download Sample Template (CSV/XLSX)</span>
// //           </a>
// //           <div>
// //             <svg className="customImport-tickbox-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
// //               <path d="M64 32C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64h320c35.3 0 64-28.7 64-64V96c0-35.3-28.7-64-64-64H64zM337 209L209 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L303 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z" />
// //             </svg>
// //             <p>Ensure all mandatory fields are filled.</p>
// //           </div>
// //           <div>
// //             <svg className="customImport-download-blue-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
// //               <path d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32v242.7l-73.4-73.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l128 128c12.5 12.5 32.8 12.5 45.3 0l128-128c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L288 274.7V32zM64 352c-35.3 0-64 28.7-64 64v32c0 35.3 28.7 64 64 64h384c35.3 0 64-28.7 64-64v-32c0-35.3-28.7-64-64-64H346.5l-45.3 45.3c-25 25-65.5 25-90.5 0L165.5 352H64zm368 56a24 24 0 1 1 0 48 24 24 0 1 1 0-48z" />
// //             </svg>
// //             <p>After importing, review and update customer data for completeness and accuracy.</p>
// //           </div>
// //         </div>
...
// //           <nav className="customImport-uploadbox-container">
// //             <nav>
// //               <button className="customImport-reser-img-btn" type="button" onClick={handleReset}>
// //                 Reset
// //               </button>
// //             </nav>
// //             <div
...
// //             >
// //               <svg xmlns="http://www.w3.org/2000/svg" className="customImport-file-logo" viewBox="0 0 29 32" fill="none">
...
// //         <div className="customImport-validation-container">
// //           <div className="customImport-validation-tit">
// //             <svg className="customImport-validation-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
// //               <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z" />
// //             </svg>
// //             <p>Validation</p>
// //           </div>
...
// //             <nav className="customImport-info-tit">
// //               <svg className="customImport-alert-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
// //                 <path d="M256 32c14.2 0 27.3 7.5 34.5 19.8l216 368c7.3 12.4 7.3 27.7 .2 40.1S486.3 480 472 480L40 480c-14.3 0-27.6-7.7-34.7-20.1s-7-27.8 .2-40.1l216-368C228.7 39.5 241.8 32 256 32zm0 128c-13.3 0-24 10.7-24 24l0 112c0 13.3 10.7 24 24 24s24-10.7 24-24l0-112c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" />
// //               </svg>
...
// //             <nav className="customImport-info-tit">
// //               <svg className="customImport-alert-red-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
// //                 <path d="M256 32c14.2 0 27.3 7.5 34.5 19.8l216 368c7.3 12.4 7.3 27.7 .2 40.1S486.3 480 472 480L40 480c-14.3 0-27.6-7.7-34.7-20.1s-7-27.8 .2-40.1l216-368C228.7 39.5 241.8 32 256 32zm0 128c-13.3 0-24 10.7-24 24l0 112c0 13.3 10.7 24 24 24s24-10.7 24-24l0-112c0-13.3-10.7-24-24-24zm32 224a32 32 0 1 0 -64 0 32 32 0 1 0 64 0z" />
// //               </svg>
...
// //           {hasValidated && (
// //             <nav className="customImport-info-tit" style={{ color: "#2e7d32" }}>
// //               <svg className="customImport-validation-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
// //                 <path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209L241 337c-9.4 9.4-24.6 9.4-33.9 0l-64-64c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l47 47L335 175c9.4-9.4 24.6-9.4 33.9 0s9.4 24.6 0 33.9z" />
// //               </svg>
...
// //             <div>
// //               <nav className="customImport-info-tit">
// //                 <svg className="customImport-skipped-logo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
// //                   <path d="M367.2 412.5L99.5 144.8C77.1 176.1 64 214.5 64 256c0 106 86 192 192 192c41.5 0 79.9-13.1 111.2-35.5zm45.3-45.3C434.9 335.9 448 297.5 448 256c0-106-86-192-192-192c-41.5 0-79.9 13.1-111.2 35.5L412.5 367.2zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z" />
// //                 </svg>
// //                 <p>Skipped Rows:</p>
// //               </nav>
// //               <p>{skippedCount} row(s) skipped due to duplicate customer ID or name.</p>
// //             </div>
// //           )}
// //         </div>
...
// //         {/* ── ACTIONS ── */}
// //         <div className="customImport-submit-container">
// //           <nav onClick={() => { setShowCustomImport(false); setFiles([]); }}>
// //             Cancel
// //           </nav>
// //           <button
// //             type="submit"
...
export default function CustomImport({ setShowCustomImport, setCustomers }) {
  ...
  const handleImportFileSubmit = async (e) => {
    ...
    if (data) {
      // Update parent customer list
      if (Array.isArray(data) && data.length > 0) {
        setCustomers?.((prev) => [...prev, ...data]);
      }

      // Show success toast BEFORE closing so user sees it
      const count =
        data?.created_count ??
        data?.count ??
      ...
      toast.success(
        count
          ? `${count} customer(s) imported successfully!`
  ...
  return (
    <div
      ...
      onDrop={handleDrop}
    >
      {/* Toast must be inside this component since it may unmount before parent toast shows */}
      ...
      <form onSubmit={handleImportFileSubmit}>
        ...
        <div className="customImport-info-container">
          ...
          {/* Import success message — shown while waiting to close */}
          {isConfirming === false && validationResult === null && (
            null // reset state — nothing to show
          )}
        </div>
        ...
        <div className="customImport-submit-container">
          ...
          <button
            type="submit"
            disabled={!canSubmit || isConfirming}
            style={!canSubmit || isConfirming ? { opacity: 0.5, cursor: "not-allowed" } : {}}
          >
            {isConfirming ? "Importing..." : "Submit"}
          </button>
        </div>
