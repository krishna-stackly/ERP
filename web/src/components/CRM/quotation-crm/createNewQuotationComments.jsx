...
//   useEffect(() => {
//     setCommentData([
//       { person_name: "Mandy", comment: "Discussed discount approval with manager.", timestamp: "May 2, 2025, 09:45 AM" },
//       { person_name: "Director", comment: "Discussed discount approval with manager.", timestamp: "May 3, 2025, 11:45 AM" },
//       { person_name: "Rose", comment: "Customer asked for delivery date confirmation.", timestamp: "May 5, 2025, 12:45 AM" },
//     ]);
//   }, []);
...
//         />
//         <button onClick={handleAddComment} type="submit">+ Add</button>
//       </form>
...
//             </svg>
//             <div className="newQuotation-message-box">
//               <p>{ele.person_name} - {ele.timestamp}</p>
//               <nav>{ele.comment}</nav>
//             </div>
//           </div>
//         ))}
